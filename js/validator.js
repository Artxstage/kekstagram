let errorMessage = '';
const MAX_HASHTAG_LENGTH = 20, MAX_HASHTAGS = 5, inputForm = document.querySelector('.img-upload__form'),
    submitButton = inputForm.querySelector('.img-upload__submit'),
    inputHashtag = inputForm.querySelector('.text__hashtags'), pristine = new Pristine(inputForm, {
    ...
    }), error = () => errorMessage, hashtagsHandler = (text) => {
      errorMessage = '';

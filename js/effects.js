const sliderOptions = {
    ...
    }, editForm = document.querySelector('.img-upload__overlay'), effectsList = editForm.querySelector('.effects__list'),
    imageElement = editForm.querySelector('.img-upload__preview').children[0],
    sliderField = editForm.querySelector('.img-upload__effect-level'),
    sliderElement = editForm.querySelector('.effect-level__slider'),
    effectLevel = editForm.querySelector('.effect-level__value'), effects = {
      none: () => {

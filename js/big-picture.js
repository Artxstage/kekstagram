const COMMENTS_TO_SHOW = 5, bigPicture = document.querySelector('.big-picture'),
    closeButton = bigPicture.querySelector('.big-picture__cancel'),
    comments = bigPicture.querySelector('.social__comments'), loadButton = bigPicture.querySelector('.comments-loader'),
